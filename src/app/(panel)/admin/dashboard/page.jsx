    ...
    <div className="container-fluid p-0">
      ...
      <div className="mb-3 mb-md-4">
        ...
        <p className="text-muted mb-0 small fs-md-6 text-break">
          Selamat datang kembali. Ringkasan status router MikroTik, performa jaringan, dan tagihan Anda.
        </p>
      </div>
      ...
      <div className="row g-3 g-md-4 align-items-start">
        ...
        <div className="col-12 col-xl-4 col-xxl-3 d-flex flex-column gap-3 gap-md-4">
          ...
          >
            ...
            {/* Address */}
            <div className="text-white-50 mb-3 small" style={{ fontSize: "12px" }}>
              <div className="text-break">Natar, Lampung Selatan, 35456</div>
              <div>Indonesia</div>
            </div>
            ...
            <div className="py-2 border-top border-bottom border-white border-opacity-25 small mb-3">
              <div className="d-flex justify-content-between align-items-center mb-1 gap-2">
                <span className="text-white-50 flex-shrink-0" style={{ fontSize: "12px" }}>ID Pelanggan</span>
                <span className="fw-semibold font-monospace text-white text-truncate" style={{ fontSize: "12px" }}>NOC-88492</span>
              </div>
              <div className="d-flex justify-content-between align-items-center gap-2">
                <span className="text-white-50 flex-shrink-0" style={{ fontSize: "12px" }}>IP Binding</span>
                <span className="fw-semibold font-monospace text-white text-truncate" style={{ fontSize: "12px" }}>10.10.20.150</span>
              </div>
            </div>
            ...
            <div>
              <div className="d-flex justify-content-between align-items-center mb-1 gap-2">
                <span className="text-white-50 small flex-shrink-0" style={{ fontSize: "12px" }}>Paket Aktif:</span>
                <span className="badge bg-success text-white px-2 py-1 flex-shrink-0" style={{ fontSize: "10px" }}>Active</span>
              </div>
              <h6 className="fw-bold text-white mb-2 fs-6 text-break">Nocsphere</h6>
            </div>
          </div>
          ...
          <div className="card p-3 p-sm-4" style={cardCleanStyle}>
            ...
            <p className="text-muted small mb-3" style={{ fontSize: "12px" }}>
              Butuh bantuan teknis atau pelaporan gangguan jaringan? Buat tiket dukungan sekarang.
            </p>
        ...
        <div className="col-12 col-xl-8 col-xxl-9" style={{ minWidth: 0 }}>
          ...
          >
            <div className="row g-3 align-items-center">
              <div className="col-12 col-md-8">
                <h5 className="fw-bold text-white mb-1 fs-6 fs-md-5">Client Portal & Self-Service</h5>
                <p className="text-secondary small mb-0 text-break" style={{ fontSize: "13px" }}>
                  Kelola isolir otomatis, pemantauan trafik router MikroTik, dan pembayaran invoice secara mudah.
                </p>
              </div>
          ...
          <div className="row g-3 mb-3 mb-md-4">
            <div className="col-12 col-sm-6 col-md-4">
              <div className="card p-3 p-sm-4 h-100" style={cardCleanStyle}>
                <span className="text-secondary small fw-medium mb-1">Pendapatan (Bulan Ini)</span>
                <h4 className="fw-bold text-dark mb-1 fs-5 fs-md-4">Rp 000</h4>
                <span className="text-success small fw-medium d-flex align-items-center gap-1">
                  <i className="bi bi-arrow-up-short fs-6"></i> +12% dari bulan lalu
                </span>
              </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-md-4">
              <div className="card p-3 p-sm-4 h-100" style={cardCleanStyle}>
                <span className="text-secondary small fw-medium mb-1">Invoice Unpaid</span>
                <h4 className="fw-bold text-dark mb-1 fs-5 fs-md-4">8 Invoice</h4>
                <span className="text-danger small fw-medium">Rp 2.100.000 terhutang</span>
              </div>
            </div>

            <div className="col-12 col-sm-12 col-md-4">
              <div className="card p-3 p-sm-4 h-100" style={cardCleanStyle}>
                <span className="text-secondary small fw-medium mb-1">PPPoE Down</span>
                <h4 className="fw-bold text-dark mb-1 fs-5 fs-md-4">3 Session</h4>
                <span className="text-danger small fw-medium">Sesi terputus / RTO</span>
              </div>
            </div>
          </div>

          {/* TABLE 1: ROUTERS (Status: Online & Offline Only) */}
          <div className="card mb-3 mb-md-4 overflow-hidden" style={cardCleanStyle}>
            <div className="p-3 p-sm-4 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div className="d-flex align-items-center gap-2 flex-wrap">
                <h5 className="fw-bold text-dark mb-0 fs-6 fs-md-5 me-2">Routers</h5>
                      ...
                      <li key={item}>
                        <button
                          className={`dropdown-item rounded-2 py-1 px-3 fw-medium ${
                            routerFilter === item ? "bg-light text-dark fw-bold" : "text-secondary"
                          }`}
                  ...
                  <ul className="dropdown-menu dropdown-menu-start rounded-3 mt-1" style={dropdownMenuStyle}>
                    {["Newest", "Oldest"].map((item) => (
                      <li key={item}>
                        <button
                          className={`dropdown-item rounded-2 py-1 px-3 fw-medium ${
                            routerSort === item ? "bg-light text-dark fw-bold" : "text-secondary"
                          }`}
              ...
              <Link href="/admin/routers" className="text-decoration-none text-secondary fw-semibold small d-flex align-items-center gap-1">
            ...
            <div className="table-responsive">
              <table className="table align-middle mb-0" style={{ fontSize: "14px" }}>
                ...
                <tbody>
                  <tr>
                    <td className="px-3 px-sm-4 py-3 fw-bold text-dark text-nowrap">RTR-GW.1</td>
                    <td className="py-3 text-secondary text-nowrap">CCR1009 - Main Gateway</td>
                    <td className="py-3 fw-semibold text-dark fw-medium text-nowrap" style={{ fontSize: "13px" }}>
                      103.150.20.1
                    </td>
                    <td className="py-3 text-secondary text-nowrap">Aug 09, 2026</td>
                  ...
                  <tr>
                    <td className="px-3 px-sm-4 py-3 fw-bold text-dark text-nowrap">OLT-DIS.2</td>
                    <td className="py-3 text-secondary text-nowrap">RB3011 - Distribution OLT</td>
                    <td className="py-3 fw-semibold text-dark fw-medium text-nowrap" style={{ fontSize: "13px" }}>
                      103.150.20.2
                    </td>
                    <td className="py-3 text-secondary text-nowrap">Sep 15, 2026</td>
                    <td className="py-3 text-nowrap">
                      <span
                        className="badge rounded-pill px-2 py-1 fw-semibold d-inline-flex align-items-center gap-1"
                        style={{ backgroundColor: "#e6f4ea", color: "#137333", fontSize: "12px" }}
                  ...
                  <tr>
                    <td className="px-3 px-sm-4 py-3 fw-bold text-dark text-nowrap">RTR-BRT.5</td>
                    <td className="py-3 text-secondary text-nowrap">RB750Gr3 - Sektor Barat</td>
                    <td className="py-3 fw-semibold text-dark fw-medium text-nowrap" style={{ fontSize: "13px" }}>
                      103.150.20.5
                    </td>
                    <td className="py-3 text-secondary text-nowrap">Jul 10, 2026</td>
                    <td className="py-3 text-nowrap">
                      <span
                        className="badge rounded-pill px-2 py-1 fw-semibold d-inline-flex align-items-center gap-1"
          ...
          <div className="card overflow-hidden mb-4" style={cardCleanStyle}>
            <div className="p-3 p-sm-4 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-2">
              <div className="d-flex align-items-center gap-2 flex-wrap">
                <h5 className="fw-bold text-dark mb-0 fs-6 fs-md-5 me-2">Invoices</h5>
                  ...
                  <ul className="dropdown-menu dropdown-menu-start rounded-3 mt-1" style={dropdownMenuStyle}>
                    {["All Invoices", "Paid", "Pending", "Unpaid"].map((item) => (
                      <li key={item}>
                        <button
                          className={`dropdown-item rounded-2 py-1 px-3 fw-medium ${
                            invoiceFilter === item ? "bg-light text-dark fw-bold" : "text-secondary"
                          }`}
              ...
              <Link href="/admin/invoices" className="text-decoration-none text-secondary fw-semibold small d-flex align-items-center gap-1">
                View All <i className="bi bi-arrow-right"></i>
              </Link>
            </div>
            ...
            <div className="table-responsive">
              <table className="table align-middle mb-0" style={{ fontSize: "14px" }}>
                <thead>
                  <tr className="text-uppercase text-secondary" style={{ fontSize: "11px", letterSpacing: "0.5px" }}>
                    <th className="px-3 px-sm-4 py-3 fw-bold border-bottom">Invoice ID</th>
                ...
                <tbody>
                  <tr>
                    <td className="px-3 px-sm-4 py-3 font-monospace fw-bold text-dark text-nowrap">INV-2026-001</td>
                    <td className="py-3 text-secondary text-nowrap">Randi Saputra</td>
                    <td className="py-3 text-secondary text-nowrap">Jul 25, 2026</td>
                    <td className="py-3 fw-bold text-dark text-nowrap">Rp 250.000</td>
                    <td className="py-3 text-nowrap">
                      <span
                        className="badge rounded-pill px-2 py-1 fw-semibold d-inline-flex align-items-center gap-1"
                        style={{ backgroundColor: "#e6f4ea", color: "#137333", fontSize: "12px" }}
                  ...
                  <tr>
                    <td className="px-3 px-sm-4 py-3 font-monospace fw-bold text-dark text-nowrap">INV-2026-002</td>
                    <td className="py-3 text-secondary text-nowrap">Studio Cyber</td>
                    <td className="py-3 text-secondary text-nowrap">Jul 20, 2026</td>
                    <td className="py-3 fw-bold text-dark text-nowrap">Rp 750.000</td>
                    <td className="py-3 text-nowrap">
                      <span
                        className="badge rounded-pill px-2 py-1 fw-semibold d-inline-flex align-items-center gap-1"
                  ...
                  <tr>
                    <td className="px-3 px-sm-4 py-3 font-monospace fw-bold text-dark text-nowrap">INV-2026-003</td>
                    <td className="py-3 text-secondary text-nowrap">Kopi Kenangan Network</td>
                    <td className="py-3 text-secondary text-nowrap">Jul 18, 2026</td>
                    <td className="py-3 fw-bold text-dark text-nowrap">Rp 500.000</td>
                    <td className="py-3 text-nowrap">
                      <span
                        className="badge rounded-pill px-2 py-1 fw-semibold d-inline-flex align-items-center gap-1"
                        style={{ backgroundColor: "#fce8e6", color: "#c5221f", fontSize: "12px" }}
                      >
                        <i className="bi bi-exclamation-circle-fill" style={{ fontSize: "11px" }}></i>
                        <span>Unpaid</span>
                      </span>
                    </td>
                    <td className="px-3 px-sm-4 py-3 text-end text-secondary">
