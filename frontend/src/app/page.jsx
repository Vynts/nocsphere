    ...
    <>
          ...
          <div className="row py-5 my-5 justify-content-center text-center">
            ...
            <div className="row justify-content-center mt-5">
              <div className="col-12 col-md-12 col-lg-10">
                ...
                >
                  <iframe
                    src="https://www.youtube.com/embed/ljakgN0ifuY?si=vO6ibGS4zWeYim1T"
      ...
      <section className="container py-5">
        <div className="text-center mb-5">
          ...
          <h2 className="fw-bold mt-1">Our Billing Management</h2>
        </div>

        <div className="row g-4 justify-content-center">
          {/* PPPoE Billing Card */}
          <div className="col-sm-10 col-md-6 col-lg-3">
            <div className="product-card p-4 d-flex flex-column h-100">
              <h5 className="fw-bold mb-1">PPPoE Billing</h5>
              <p className="text-muted small mb-3">Starting at</p>
              ...
              <ul
                className="list-unstyled mb-4 flex-grow-1 text-muted small"
                style={{ lineHeight: "2.2" }}
              >
                <li>
                  <i className="fa-solid fa-user-check me-2"></i> Auto Create
                  Secrets & Profiles
                </li>
                <li>
                  <i className="fa-solid fa-ban me-2"></i> Automated Isolation
                  System
                </li>
                <li>
                  <i className="fa-solid fa-receipt me-2"></i> WhatsApp PDF
                  Invoice
                </li>
                <li>
                  <i className="fa-solid fa-chart-line me-2"></i> Realtime
                  Traffic Monitor
                </li>
              </ul>

              <div className="d-flex align-items-center mb-3 text-muted gap-2">
                <i className="fa-solid fa-network-wired text-primary"></i>
                <span className="small fw-600 text-dark">MikroTik API v7</span>
              </div>
              <a href="#" className="btn btn-custom-dark mt-auto">
                Learn More
              </a>
            </div>
          </div>

          {/* Hotspot Voucher Card */}
          <div className="col-sm-10 col-md-6 col-lg-3">
            <div className="product-card p-4 d-flex flex-column h-100">
              <h5 className="fw-bold mb-1">Hotspot Voucher</h5>
              <p className="text-muted small mb-3">Starting at</p>
              <h3 className="fw-bold mb-4">
                Rp 40.000{" "}
                <span className="fs-6 text-muted fw-normal">/month</span>
              ...
              >
                <li>
                  <i className="fa-solid fa-ticket me-2"></i> Bulk Voucher
                  Generator
                </li>
                <li>
                  <i className="fa-solid fa-clock me-2"></i> Time & Volume
                  Limiters
                </li>
                <li>
                  <i className="fa-solid fa-print me-2"></i> Ready-to-print
                  Template
                </li>
                <li>
                  <i className="fa-solid fa-qrcode me-2"></i> Scan QR Code Login
                </li>
              </ul>

              <div className="d-flex align-items-center mb-3 text-muted gap-2">
                <i className="fa-solid fa-wifi text-warning"></i>
          ...
          <div className="col-sm-10 col-md-6 col-lg-3">
            <div className="product-card p-4 d-flex flex-column h-100">
              <h5 className="fw-bold mb-1">Multi Router API</h5>
              <p className="text-muted small mb-3">Starting at</p>
              <h3 className="fw-bold mb-4">
                Rp 10.000{" "}
                <span className="fs-6 text-muted fw-normal">/router</span>
              </h3>
              ...
              >
                <li>
                  <i className="fa-solid fa-server me-2"></i> Centralized
                  Control Dashboard
                </li>
                <li>
                  <i className="fa-solid fa-layer-group me-2"></i> Unlimited
                  Router Boards
                </li>
                <li>
                  <i className="fa-solid fa-eye me-2"></i> Resource & CPU
                  Monitoring
                </li>
                <li>
                  <i className="fa-solid fa-shield-halved me-2"></i> Secure SSL
                  API Port
                </li>
              </ul>
          ...
          <div className="col-sm-10 col-md-6 col-lg-3">
            <div className="product-card p-4 d-flex flex-column h-100">
              <h5 className="fw-bold mb-1">Payment Gateway</h5>
              <p className="text-muted small mb-3">Starting at</p>
              <h3 className="fw-bold mb-4">
                Rp 13.000{" "}
                <span className="fs-6 text-muted fw-normal">/month</span>
              ...
              >
                <li>
                  <i className="fa-solid fa-qrcode me-2"></i> QRIS Automatic
                  Detection
                </li>
                <li>
                  <i className="fa-solid fa-building-columns me-2"></i> Virtual
                  Accounts (VA)
                </li>
                <li>
                  <i className="fa-solid fa-store me-2"></i> Alfa / Indo Retail
                  Outlets
                </li>
                <li>
                  <i className="fa-solid fa-money-bill-transfer me-2"></i> Low
                  Fee Transaction Rate
                </li>
              </ul>
